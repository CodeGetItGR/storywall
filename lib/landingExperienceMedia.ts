...
export const socialExperienceAssets: LandingExperienceAsset[] = [
    ...
    ['swx-ref-asset swx-a02 swx-depth-mid swx-motion-card', '/landing/baptism-story.png', 653, 884],
    ...
    ['swx-ref-asset swx-a10 swx-depth-mid swx-motion-card', '/landing/conference-post.png', 613, 569],
    ...
    ['swx-ref-asset swx-a21 swx-depth-back swx-motion-comment', '/landing/blurred-comment.png', 384, 211],
...
export const hostExperienceAssets: LandingExperienceAsset[] = [
    ...
    ['swx-host-ref swx-h08 swx-host-depth-mid swx-host-motion-story', '/landing/baptism-story-2.png', 430, 675],
    ...
    ['swx-host-ref swx-h11 swx-host-depth-front swx-host-motion-menu', '/landing/create-content-menu.png', 693, 849],
