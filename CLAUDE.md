...
- The pattern (see [app/(main)/(app)/(event)/events/[eventId]/tools/gallery/(root)/page.tsx](<app/(main)/(app)/(event)/events/[eventId]/tools/gallery/(root)/page.tsx>), [app/(main)/(app)/(event)/events/[eventId]/manage/(root)/page.tsx](<app/(main)/(app)/(event)/events/[eventId]/manage/(root)/page.tsx>), [app/(main)/(app)/(event)/events/[eventId]/tools/wishbook/page.tsx](<app/(main)/(app)/(event)/events/[eventId]/tools/wishbook/page.tsx>) for reference):
