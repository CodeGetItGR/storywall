...
- The pattern (see [app/(app)/(event)/events/[eventId]/tools/gallery/page.tsx](<app/(app)/(event)/events/[eventId]/tools/gallery/page.tsx>), [app/(app)/(event)/events/[eventId]/manage/page.tsx](<app/(app)/(event)/events/[eventId]/manage/page.tsx>), [app/(app)/(event)/events/[eventId]/tools/wishbook/page.tsx](<app/(app)/(event)/events/[eventId]/tools/wishbook/page.tsx>) for reference):
