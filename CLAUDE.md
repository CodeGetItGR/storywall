...
- The pattern (see [app/(main)/(app)/(event)/events/[eventId]/tools/gallery/page.tsx](<app/(main)/(app)/(event)/events/[eventId]/tools/gallery/page.tsx>), [app/(main)/(app)/(event)/events/[eventId]/manage/page.tsx](<app/(main)/(app)/(event)/events/[eventId]/manage/page.tsx>), [app/(main)/(app)/(event)/events/[eventId]/tools/wishbook/page.tsx](<app/(main)/(app)/(event)/events/[eventId]/tools/wishbook/page.tsx>) for reference):
