...
export function useCreateEventSession() {
  ...
  return useMutation({
    mutationFn: (input: EventSessionRequestDto) =>
      api.post<EventSessionResponseDto>(endpoints.eventSessions.create, input),
    onSuccess: (session) => {
...
export function useUpdateEventSession(id: string, eventId: string) {
  ...
  return useMutation({
    mutationFn: (input: EventSessionPatchDto) =>
      api.patch<EventSessionResponseDto>(endpoints.eventSessions.byId(id), input),
    onSuccess: () => {
