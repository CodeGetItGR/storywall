...
export function useCreateEventMember() {
  ...
  return useMutation({
    mutationFn: (input: EventMemberRequestDto) =>
      api.post<EventMemberResponseDto>(endpoints.eventMembers.create, input),
    onSuccess: (member) => {
...
export function useUpdateEventMember(id: string, eventId: string) {
  ...
  return useMutation({
    mutationFn: (input: EventMemberPatchDto) =>
      api.patch<EventMemberResponseDto>(endpoints.eventMembers.byId(id), input),
    onSuccess: () => {
