        ...
        <div className="px-4 pt-5 pb-10">
            <div className="relative isolate overflow-hidden px-6 py-10 text-center">
                ...
                <div className="relative mx-auto flex h-24 w-24 items-center justify-center">
                    ...
                    <div className="absolute top-3 -right-1 flex h-8 w-8 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-[0_8px_20px_rgba(255,122,89,0.32)]">
                        <Sparkles className="h-4 w-4" aria-hidden="true" />
                    </div>
                    <div className="relative flex h-16 w-16 items-center justify-center rounded-full text-primary-foreground bg-gradient-brand">
