...
export function RsvpSummarySection({ eventId, summary }: RsvpSummarySectionProps) {
    ...
    const rows = [
        { key: 'attending', value: summary.attending },
        { key: 'declined', value: summary.declined },
        { key: 'noResponse', value: summary.noResponse },
    ] as const;
    ...
    return (
        <div>
            ...
            <div className="space-y-1.5 rounded-xl bg-surface-muted/70 px-3 py-2.5">
                {rows.map(({ key, value }) => (
