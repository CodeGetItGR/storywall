    ...
    return (
        <div>
            ...
            <div className="flex gap-2">
                <div className="flex flex-1 items-center gap-2 rounded-xl bg-surface-muted/70 px-3 py-2.5">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="truncate text-xs text-ink-faint">{t('images')}</p>
                    </div>
                </div>
                <div className="flex flex-1 items-center gap-2 rounded-xl bg-surface-muted/70 px-3 py-2.5">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="truncate text-xs text-ink-faint">{t('videos')}</p>
                    </div>
                </div>
            </div>
        </div>
