...
export async function LandingHeroTransition() {
    ...
    return (
        ...
        >
            <div className="relative z-20 mx-auto flex min-h-36 w-[calc(100%-34px)] items-center justify-between gap-3.5 min-[421px]:justify-center min-[421px]:gap-4.5 min-[761px]:items-start min-[761px]:pt-10 min-[761px]:min-h-54 min-[761px]:w-[min(1500px,calc(100%-120px))] min-[761px]:gap-7">
