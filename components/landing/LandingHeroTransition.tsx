...
export async function LandingHeroTransition() {
    ...
    return (
        ...
        >
            <div className="relative z-20 mx-auto flex min-h-36 w-[calc(100%-34px)] items-center justify-center gap-3 min-[421px]:gap-7 min-[761px]:items-start min-[761px]:justify-center min-[761px]:pt-10 min-[761px]:min-h-54 min-[761px]:w-[min(1500px,calc(100%-120px))] min-[761px]:gap-7">
                <div className="text-center m-0 max-w-52 [font-family:var(--editorial)] text-[27px] leading-[1.12] tracking-[-0.03em] min-[421px]:max-w-64 min-[421px]:text-[26px] min-[761px]:max-w-none min-[761px]:whitespace-nowrap min-[761px]:text-[clamp(27px,2vw,42px)] min-[761px]:leading-[1.04] min-[761px]:tracking-[-0.035em] min-[761px]:mb-5">
