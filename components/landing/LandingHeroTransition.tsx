...
export async function LandingHeroTransition() {
    ...
    return (
        ...
        <section
            aria-label={t('label')}
            className="relative z-20 min-h-40 w-full isolate overflow-hidden bg-[linear-gradient(90deg,rgba(255,111,145,0.6)_0%,rgba(255,143,111,0.6)_28%,rgba(247,183,91,0.6)_58%,rgba(248,210,92,0.6)_100%)] text-[#151313] after:pointer-events-none after:absolute after:inset-x-0 after:-bottom-px after:top-0 after:z-10 after:bg-[linear-gradient(to_bottom,rgba(255,255,255,0)_0%,rgba(255,255,255,0)_30%,rgba(255,255,255,0.05)_40%,rgba(255,255,255,0.14)_50%,rgba(255,255,255,0.28)_60%,rgba(255,255,255,0.46)_70%,rgba(255,255,255,0.66)_80%,rgba(255,255,255,0.85)_90%,rgb(255,255,255)_100%)] after:content-[''] min-[761px]:min-h-44"
        >
            <div className="relative z-20 mx-auto flex min-h-36 w-[calc(100%-34px)] items-center justify-between gap-3.5 min-[421px]:justify-around min-[421px]:gap-4.5 min-[761px]:items-start min-[761px]:justify-center min-[761px]:pt-10 min-[761px]:min-h-54 min-[761px]:w-[min(1500px,calc(100%-120px))] min-[761px]:gap-7">
                <div className="m-0 max-w-34.5 [font-family:var(--editorial)] text-[19px] leading-[1.05] tracking-[-0.03em] min-[421px]:max-w-56 min-[421px]:text-[23px] min-[761px]:max-w-none min-[761px]:whitespace-nowrap min-[761px]:text-[clamp(27px,2vw,42px)] min-[761px]:leading-[1.04] min-[761px]:tracking-[-0.035em] min-[761px]:mb-5">
