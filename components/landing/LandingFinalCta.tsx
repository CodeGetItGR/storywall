...
export async function LandingFinalCta() {
    ...
    return (
        <section
            className="group block min-h-100 overflow-hidden bg-[#f5ab62] text-[#151313] min-[761px]:grid min-[761px]:max-h-none min-[761px]:min-h-0 min-[761px]:grid-cols-[44%_56%]"
            id="create"
        >
            <div className="h-[78vw] min-h-80 overflow-hidden min-[761px]:h-180 min-[761px]:min-h-0">
                <ProtectedImage
                    ...
                    height={1086}
                    loading="lazy"
                    className="block h-full w-full object-cover object-[50%_40%] contrast-[.98] saturate-[.96] transition-transform duration-1200 ease-[cubic-bezier(0.22,0.61,0.36,1)] group-hover:scale-[1.025] motion-reduce:transition-none min-[761px]:object-[50%_42%]"
                />
            </div>
            <div className="flex flex-col justify-center bg-[radial-gradient(circle_at_84%_15%,rgba(255,255,255,0.28),rgba(0,0,0,0)_31%),linear-gradient(135deg,#ffc969_0%,#f9a462_48%,#f39a72_100%)] px-5 pt-10 pb-11 min-[761px]:box-border min-[761px]:h-180 min-[761px]:px-[7vw]">
                <div aria-hidden="true" className="mb-6 flex size-12 items-center justify-center min-[761px]:mb-10.5 min-[761px]:size-14.5">
                    <svg
                        className="size-11.5 overflow-visible fill-none stroke-[#151313] stroke-[2.8] [stroke-linecap:round] [stroke-linejoin:round] min-[761px]:size-14"
                        role="presentation"
                        viewBox="0 0 64 64"
                    >
                        <path d="M32 3C34.7 19.2 44.8 29.3 61 32C44.8 34.7 34.7 44.8 32 61C29.3 44.8 19.2 34.7 3 32C19.2 29.3 29.3 19.2 32 3Z" />
                        <path
                            className="stroke-[2.2] opacity-[0.72]"
                ...
                <h2 className="m-0 max-w-205 [font-family:var(--editorial)] text-[clamp(50px,14vw,70px)] leading-[0.82] font-normal tracking-[-0.065em] min-[761px]:text-[clamp(72px,6.7vw,124px)] min-[761px]:leading-[0.78]">
                    {heading[0]}
                    <br />
                ...
                >
                    ...
                    <span
                        aria-hidden="true"
                        className="motion-final-cta-arrow inline-block text-[22px] transition-transform duration-280 ease-[ease] group-hover:translate-x-0.75 group-hover:-translate-y-0.75 min-[761px]:inline-flex min-[761px]:items-center min-[761px]:justify-center min-[761px]:text-[21px] min-[761px]:leading-none"
                    >
                        ↗
                    </span>
                </a>
