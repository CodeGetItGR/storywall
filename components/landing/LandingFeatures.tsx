            ...
            <div className="sw-feature-block mt-10.5 w-full min-[761px]:col-span-2 min-[761px]:row-start-3 min-[761px]:mx-auto min-[761px]:mt-[clamp(52px,5.2vw,76px)] min-[761px]:w-[min(88%,1480px)] min-[761px]:max-w-370">
                ...
                >
                    ...
                    <button
                        ...
                        className="sw-feature-mobile-arrow-left absolute top-11.5 left-2.5 z-8 block size-8.5 -translate-y-1/2 rounded-full bg-[rgba(10,10,14,0.28)] opacity-[0.72] transition-[opacity,background-color,transform] duration-250 ease-[ease] before:absolute before:top-1/2 before:left-1/2 before:size-2 before:translate-x-[-42%] before:-translate-y-1/2 before:rotate-[-135deg] before:border-t-2 before:border-r-2 before:border-white/82 before:content-[''] active:scale-[0.94] active:bg-[rgba(10,10,14,0.34)] active:opacity-100 min-[761px]:hidden"
                        type="button"
                    />
                    <button
                        aria-label={t('next')}
                        className="sw-feature-mobile-arrow-right absolute top-11.5 right-2.5 z-8 block size-8.5 -translate-y-1/2 rounded-full bg-[rgba(10,10,14,0.28)] opacity-[0.72] transition-[opacity,background-color,transform] duration-250 ease-[ease] before:absolute before:top-1/2 before:left-1/2 before:size-2 before:translate-x-[-58%] before:-translate-y-1/2 before:rotate-45 before:border-t-2 before:border-r-2 before:border-white/82 before:content-[''] active:scale-[0.94] active:bg-[rgba(10,10,14,0.34)] active:opacity-100 min-[761px]:hidden"
                        type="button"
                    />
                </div>
            </div>
