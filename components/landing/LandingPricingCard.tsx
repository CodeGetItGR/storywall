...
export function LandingPricingCard({
    ...
    return (
        <article
            className={`flex h-full min-h-155 flex-col rounded-[22px] px-5 pt-5 pb-4 text-[#151313] min-[761px]:min-h-166.5 min-[761px]:px-5 ${featured ? 'border border-[#f29380]' : 'border border-transparent'}`}
        >
            {/* Plan identity */}
            <div className="relative min-h-26.5 border-b border-[#151313]/15 pr-24">
