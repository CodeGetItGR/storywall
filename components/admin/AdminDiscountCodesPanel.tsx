                ...
                {visibleCodes.length > 0 && (
                    <div className="overflow-x-auto">
                        <table className="w-full min-w-[820px] border-collapse text-left text-sm">
                            <thead>
                                <tr>
                                    <th className="border-b border-border px-4 py-2.5 text-[11px] font-bold tracking-wide text-ink-faint uppercase">
                                        {tCodes('columns.code')}
                                    </th>
                                    <th className="border-b border-border px-3 py-2.5 text-[11px] font-bold tracking-wide text-ink-faint uppercase">
