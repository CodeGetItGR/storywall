 ...
 * 2026-07-30, last extended 2026-08-16 (co-host invitations, paid module unlocks, wishlist,
 * wishbook). Companion reference to docs/fe-guides/frontend-integration-guide.md, which covers
...
interface EventUsageResponseDto {
     ...
     * widened. See fe-guides/billing-fe-guide.md.
     */
    planTier: string;
    storageBytes: number;
...
interface EventModuleRequestDto {
    eventId: string;
    moduleKey: ModuleKey; // required — server now rejects any value outside the 7 canonical keys (400, INVALID_MODULE_KEY/3006); `ModuleKey` defined below under "App config"
    isEnabled: boolean;
