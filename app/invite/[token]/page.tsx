...
import { ArrowRight, HeartCrack, Loader2, User } from 'lucide-react';
...
export default function InviteOnboardingPage({ params }: { params: Promise<{ token: string }> }) {
    ...
    return (
        ...
        >
            {preview.eventDescription && <p className="text-sm text-ink-muted mb-7 leading-relaxed">{preview.eventDescription}</p>}
