...
// Bare /tools/gallery has no event id — kept only so old bookmarks/links
...
export default async function GalleryRedirectPage() {
    ...
    redirect(context?.activeEventId ? routes.events.tools.gallery(context.activeEventId) : routes.home);
}
