                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-3 bg-surface-muted rounded-xl px-4 py-3">
                                    ...
                                    <span className="flex-1 text-center text-sm font-semibold text-ink tabular-nums">
                                        {t('guestsCount', { count: plusOnes })}
                                    </span>
                                    <button
                                        type="button"
                                        onClick={() => setPlusOnes((p) => Math.min(4, p + 1))}
                                        className="w-7 h-7 rounded-full bg-card border border-border flex items-center justify-center text-ink-muted hover:text-ink transition-colors font-bold"
                                    >
                                        +
                                    </button>
                ...
                <>
                    ...
                    <div className="flex flex-col gap-2">
                        {confirmedGuests.map((guest) => (
                            <div
                                key={guest.id}
                                className="flex items-center justify-between bg-card rounded-xl px-4 py-3 border border-border/50 shadow-sm"
                            >
                                <div>
